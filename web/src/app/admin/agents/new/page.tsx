...
import { A2AEndpoint, AgentCreatePayload, McpServer, adminApi } from "@/lib/adminApi";
...
export default function NewAgentPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([adminApi.listA2AEndpoints(), adminApi.listMcpServers()])
      .then(([endpoints, servers]) => {
