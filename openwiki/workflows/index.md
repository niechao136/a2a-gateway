...
- [Agent 图构建与编排](agent-graph.md) - 解释共享 ReAct 图的构建：resolve_llm 按绑定快照或全局配置选择 LLM，pre_model_hook 的历史压缩、pending 提示与技能再注入，工具组装（A2A/MCP/技能），以及 LLM 适配层的 thought_signature 兼容处理。
